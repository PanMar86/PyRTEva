...
def generate_main_window():
    ...
    stylesheet_filepath = str(Path(__file__).resolve().parents[1]/"assets"/"custom_styles"/"main_window.qss")

    with open(stylesheet_filepath, mode="r") as main_window_qss:
...
def generate_user_preferences_window(data_container):
    ...
    stylesheet_filepath = str(Path(__file__).resolve().parents[1]/"assets"/"custom_styles"/"user_preferences_window.qss")

    with open(stylesheet_filepath, mode="r") as user_preferences_window_qss:
...
def generate_treatment_parameters_window():
    ...
    stylesheet_filepath = str(Path(__file__).resolve().parents[1]/"assets"/"custom_styles"/"treatment_parameters_window.qss")

    with open(stylesheet_filepath, mode="r") as treatment_parameters_window_qss:
    ...
    treatment_site.addItem("Prostate")
